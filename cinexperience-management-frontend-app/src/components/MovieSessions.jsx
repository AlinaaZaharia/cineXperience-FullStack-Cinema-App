...
class MovieSessions extends Component {
    ...
    fetchSessions(movieId) {
        ...
        if (!cityId) {
            console.warn("City not selected");
            this.setState({ sessions: [] });
            return;
        }

        SessionService.getSessionsByMovieAndCity(movieId, cityId)
            .then(response => {
        ...
        return (
            <div className="container mt-5">
                    ...
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col-md-8">
                                ...
                                {user?.role === "ADMIN" && (
                                    <div className="mt-3">
                                        <button className="btn btn-success me-2" onClick={this.updateMovie}>Update Movie</button>
                ...
                {sessions.length > 0 ? (
                            ...
                            {sessions.map((session) => (
                                <div className="col-md-4 mb-3" key={session.id}>
                                    <div className="card shadow">
                                        <div className="card-body">
                                            <p><strong>City:</strong> {session.city?.name || "N/A"}</p>
                    ...
                    <p>No sessions available for this movie in the selected city.</p>
                )}
            </div>
        );
    }
